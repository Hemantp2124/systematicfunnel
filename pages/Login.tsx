    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
       <div className="w-full max-w-md bg-surface border border-border rounded-2xl p-8 shadow-2xl animate-in fade-in slide-in-from-bottom-8 duration-500">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
             ...
             <button 
               type="submit"
               className="w-full bg-primary hover:bg-primaryHover text-white font-bold py-3 rounded-lg transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2"
             >
             ...
             <div className="relative flex py-2 items-center">
                ...
                <span className="flex-shrink-0 mx-4 text-textMuted text-xs">OR TEST IMMEDIATELY</span>
                <div className="flex-grow border-t border-border"></div>
             </div>
             ...
             <button 
               type="button"
               onClick={() => {
                  onLogin('demo@systematicfunnels.com');
                  navigate('/dashboard');
               }}
               className="w-full bg-surface hover:bg-surfaceHover border border-primary/30 text-textMain font-bold py-3 rounded-lg transition-all flex items-center justify-center gap-2 group"
             >
                <Sparkles size={18} className="text-secondary group-hover:text-primary transition-colors" /> 
                Try Demo Account
             </button>
          </form>
